        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       class="w-full bg-white border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-300' }} rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 focus:outline-none"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="phone" value="{{ old('phone') }}"
                       class="w-full bg-white border {{ $errors->has('phone') ? 'border-red-500' : 'border-gray-300' }} rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 focus:outline-none"
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" value="{{ old('email') }}"
                       class="w-full bg-white border {{ $errors->has('email') ? 'border-red-500' : 'border-gray-300' }} rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 focus:outline-none"
            ...
            <!-- Tombol Daftar - lebih tebal dan kokoh -->
            <button type="submit"
